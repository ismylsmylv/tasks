...
// 1 sort in descending order based id
...
// 4 unitPrice greater than 22
// let finder = arr.filter((prod) => prod.unitPrice >22)
// console.log(finder);

// 5 from Spain
// let finder = arr.filter((prod) => prod.supplier?.address.country == "Spain")
// console.log(finder);
...
// ]
//every some
// let obj = (element) => element.isDiscounted == true;
// console.log(arr.some(obj));
// console.log(arr.every(obj));